...
Given a basic set of projects as defined here[qed://support/projects.rdoc].
...
Secondary information, taken from the PROFILE, can be queried via the #metadata
method.

  tryme10.metadata.homepage.assert == "http://tryme.foo"
  tryme11.metadata.homepage.assert == "http://tryme.foo"
