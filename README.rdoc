...
* work: http://github.com/protuils/roll
...
they must all reside. You simply tell Rolls where they are. This is include
standard gem locations. Rolls can serve gem installed libraries as easily
as it serve-up your development libraries.
...
If you want to use RubyGems along side Rolls, this can be done too:

  $ export RUBYOPT="-roll -rubygems"

The alternative to this is to add you gem locations to your roll 
...
Note the use of +sudo+ here. Rolls will create <code>.ruby/</coide>
...
the .ruby/name or .ruby/loapath files. To clarify, take a look at the
+show+ command.
