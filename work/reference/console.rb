  ...
  module Console0
    ...
    def bootstrap!(name=nil)
      ...
      if File.exist?(lock_file)
        ...
        ENV['RUBY_LIBRARY'] = paths.join( windows_platform? ? ';' : ':' )
      ...
      # NOTE: It doesn't look like we can not do this b/c it prevents gems from working
      # when a file has the same name as something in the ruby lib and site locations.
      # For example, if we install the test-unit gem and require `test/unit`.
